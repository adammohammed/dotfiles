...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ;;(setq eclim-eclipse-dirs "~/opt/eclipse" eclim-executable "~/opt/eclipse/eclim")
